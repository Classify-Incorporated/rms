        ...
        <div class="page-header d-print-none">
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title">
                            Certificate of Latin Honors - View File
                        </h2>
                    </div>
                    <!-- Page title actions -->
                ...
                <div class="card card-lg">
                    <div class="card-body">
                        ...
                        <div class="body-text-intro">
                            ...
                            Student No.<text> 20190208</text> <strong class="course">Bachelor of Early Childhood
                                Education (BECE)</strong> on <text>October 7, 2022</text> He was a recipient of the
                            Latin Honors for the Academic Year
                            <text>2022-2023</text> as <strong>"Cum Laude"</strong>.
                        </div>
                        <div class="text-bottom mb-4">
                            This certification is being issued upod the request of <strong>Ms. Kuyan</strong> this
                            <text>27th</text> day of <text>October,2022</text> for reference purposes only.
                        </div>
                        <div class="signature">
                            <div>
                                <p>
